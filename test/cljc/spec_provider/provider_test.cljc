...
(deftest infer-specs-test
  ...
  (testing "map optional keys"
    (is (= '((clojure.spec.alpha/def :foo/a integer?)
    ...
    (is (= `((clojure.spec.alpha/def :foo/a integer?)
           ...
           (pr/infer-specs [{:a 1}
                         {}
                         {}] :foo/stuff)))
    (is (= `((clojure.spec.alpha/def :foo/b integer?)
             (clojure.spec.alpha/def :foo/a integer?)
  ...
  (testing "maps that don't have keywords as keys"
    (is (= `((clojure.spec.alpha/def
               :foo/stuff
               (clojure.spec.alpha/map-of string? integer?)))
           (pr/infer-specs [{"a" 3}
                         {"b" 4}] :foo/stuff)))
    (is (= `((clojure.spec.alpha/def
               :foo/stuff
               (clojure.spec.alpha/map-of
                (clojure.spec.alpha/coll-of
                 (clojure.spec.alpha/nilable
                  (clojure.spec.alpha/or :integer integer? :keyword keyword?)))
                integer?)))
    ...
    (testing "- mixed"
      (is (= `((clojure.spec.alpha/def :foo/a integer?)
               (clojure.spec.alpha/def
                 ...
                 (clojure.spec.alpha/or
                  :non-keyword-map
                  (clojure.spec.alpha/map-of integer? integer?)
                  :keyword-map
  ...
  (testing "issue #1 - coll-of overrides everything"
    (is (= `((clojure.spec.alpha/def
               :spec-provider.provider-test/stuff
               (clojure.spec.alpha/or
                :collection (clojure.spec.alpha/coll-of integer?)
                :map (clojure.spec.alpha/and clojure.core/empty? clojure.core/map?)
                :set (clojure.spec.alpha/coll-of clojure.core/any? :kind clojure.core/set?)
                :simple
                (clojure.spec.alpha/or
  ...
  (testing "do I know you from somewhere?"
    (is (= `((clojure.spec.alpha/def :foo/zz integer?)
  ...
  (testing "sets"
    ...
    (testing "- nilable"
      (is (= `((clojure.spec.alpha/def
                 :foo/a
                 (clojure.spec.alpha/nilable
                  (clojure.spec.alpha/coll-of integer? :kind clojure.core/set?)))
  ...
  (testing "numerical ranges"
    (testing "- for all keys"
     (is (= `((clojure.spec.alpha/def :spec-provider.provider-test/bar
                (clojure.spec.alpha/and integer? (clojure.core/fn [x] (clojure.core/<= -400 x 400))))
              (clojure.spec.alpha/def :spec-provider.provider-test/foo
                (clojure.spec.alpha/and integer? (clojure.core/fn [x] (clojure.core/<= 3 x 10))))
    ...
    (testing "- for specific keys"
      (is (= `((clojure.spec.alpha/def :spec-provider.provider-test/bar integer?)
               (clojure.spec.alpha/def :spec-provider.provider-test/foo
                 (clojure.spec.alpha/and integer? (clojure.core/fn [x] (clojure.core/<= 3 x 10))))
               (clojure.spec.alpha/def :spec-provider.provider-test/stuff
                 (clojure.spec.alpha/keys :req-un [:spec-provider.provider-test/bar :spec-provider.provider-test/foo])))
    ...
    (testing "- for map-of"
      (is (= `((clojure.spec.alpha/def :spec-provider.provider-test/stuff
                 (clojure.spec.alpha/map-of
                  (clojure.spec.alpha/and integer? (clojure.core/fn [x] (clojure.core/<= 1 x 4)))
                  (clojure.spec.alpha/and integer? (clojure.core/fn [x] (clojure.core/<= 100 x 1000))))))
    ...
    (testing "- ignored when the key is not numerical"
      (is (= `((clojure.spec.alpha/def :spec-provider.provider-test/bar string?)
               (clojure.spec.alpha/def :spec-provider.provider-test/foo integer?)
               (clojure.spec.alpha/def :spec-provider.provider-test/stuff
                 (clojure.spec.alpha/keys :req-un [:spec-provider.provider-test/bar :spec-provider.provider-test/foo])))
    ...
    (testing "- with mixed values"
      (is (= `((clojure.spec.alpha/def :spec-provider.provider-test/bar
                 (clojure.spec.alpha/or
                  :integer (clojure.spec.alpha/and integer? (clojure.core/fn [x] (clojure.core/<= 1 x 100)))
                  :string string?))
               (clojure.spec.alpha/def :spec-provider.provider-test/foo
                 (clojure.spec.alpha/and integer? (clojure.core/fn [x] (clojure.core/<= 3 x 10))))
               (clojure.spec.alpha/def :spec-provider.provider-test/stuff
